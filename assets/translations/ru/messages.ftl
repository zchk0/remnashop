...
msg-broadcast-excluded-users =
    ...
    • <b>По времени регистрации</b>: { $registration_exclusion_days ->
        [7] зарегистрированные за последние 7 дней
        [30] зарегистрированные за последние 30 дней
        [90] зарегистрированные за последние 90 дней
       *[0] не исключаются
    }
    • <b>Получателей после исключений</b>: { $audience_count }
    </blockquote>

    Выберите период регистрации кнопкой ниже. Квартал считается как последние 90 дней.
