...
btn-broadcast =
    ...
    .excluded-users = 🚫 Исключения ({ $count } ID, { $registration_days ->
        [7] 7 дней
        [30] 30 дней
        [90] 90 дней
       *[0] без периода
    })
    .excluded-users-reset = 🗑️ Очистить исключения
    .registration-exclusion = { $selected ->
        [1] 🔘
       *[0] ⚪
    } { $days ->
        [7] Исключить зарегистрированных за неделю
        [30] Исключить зарегистрированных за месяц
        [90] Исключить зарегистрированных за квартал
