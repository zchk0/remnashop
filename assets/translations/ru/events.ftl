...
event-remnashop-welcome =
    ...
    ВПН сервис реализующий полный цикл предоставления услуг от собственных решений на различные платформы до выдачи простых конфиг-подписок для ваших приложений-клиентов.

    ⭐ <i>Поставьте звездочку на <a href="{ $repository }">GitHub</a> и присоединяйтесь к нашему <a href="https://t.me/@alstrive">сообществу</a>.</i>