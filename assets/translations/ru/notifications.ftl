ntf-error =
    ...
    .remnawave-unavailable = ⚠️ <i>Сервис подписок временно недоступен. Попробуйте ещё раз через несколько секунд.</i>
...
ntf-devices =
    ...
    .subscription-link-reset =
        ⚠️ <i>Ссылка подписки была сброшена после отвязки устройства в ToBeVPN.</i>

        <b>Новая ссылка:</b>
        <code>{ $subscription_url }</code>

        <i>Если вы используете другие клиенты (Happ, V2rayNG и т.д.), то добавьте в них новую ссылку.</i>
